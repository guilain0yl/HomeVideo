...
* 作    者 ：guilain
* 创建时间 ：2019/10/29 11:18:54
* 更新时间 ：2019/10/29 11:18:54
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
namespace Util
{
    public static class VerificationHelper
    {
        ...
        /// <param name="rule">正则枚举</param>
        /// <returns></returns>
        public static bool Verification(this string str, REGEXRULE rule) => Verification(str, ver_rule[rule.ToInt()]);
        ...
        /// <returns></returns>
        public static bool Verification(this string str, string pattern) => (new Regex(pattern)).IsMatch(str);
